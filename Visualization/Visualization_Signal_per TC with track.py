...
num = '01'
tc = f'{num} Amang'
gdfdir = f'D:/Ezra/Python/Test/Json per TC/{tc}.json'
sdfdir = 'D:/Ezra/Python/Test/Data/Edited_Province.json'
dfdir = f'D:/Ezra/Python/Test/PH2023{num}.txt'
savedir = f'D:/Ezra/Python/Test/{tc}.jpg'
...
ax.legend(handles=handles, labels=labels, loc='upper right',  prop={'family': 'Arial', 'weight': 'bold', 'size': 18})
...
# xmin = x_center - lon_range
# xmax = x_center + lon_range
# ymin = y_center - (lat_range * 0.7727)
# ymax = y_center + (lat_range * 0.7727)

# for mahaba 
# Calculate new limits
# xmin = x_center - (lon_range * 0.7727)
# xmax = x_center + (lon_range * 0.7727)
# ymin = y_center 
# ymax = y_center 
