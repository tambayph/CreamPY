...
gdfdir = f'{tcname}.json'
sdfdir = 'Edited_Province.json'
dfdir = f'PH{year}{tcid}.txt'
savedir = f'{tcname}.jpg'
...
with open(f'{tcname}.csv', mode='w', newline='') as file:
...
# Load the CSV data
with open(f'{tcname}.csv', encoding='ISO-8859-1') as f:
    reader = csv.reader(f)
...
with open(f'{tcname}.json', 'w') as f:
    json.dump(data, f)
