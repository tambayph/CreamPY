...
file1 = pd.read_csv('D:/Ezra/Python/Scripts/Merged_Signals.csv')

file2 = pd.read_csv('D:/Ezra/Python/Scripts/Signal_15.csv')
...
merged_df.to_csv('D:/Ezra/Python/Scripts/Merged_Signals.csv', index=False)
